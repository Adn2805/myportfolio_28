...
<head>
  ...
  <style>
    ...
    :root {
      ...
      --glass-border: rgba(0, 245, 196, 0.12);
      --radius: 12px;
      --radius-lg: 20px;
      --radius-pill: 100px;
    }
    ...
    *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .bg-mesh {
      ...
      background:
        ...
        radial-gradient(ellipse 60% 80% at 80% 90%, rgba(0,245,196,.06) 0%, transparent 60%),
        radial-gradient(ellipse 70% 50% at 60% 40%, rgba(255,107,53,.04) 0%, transparent 60%);
    ...
    .cursor-ring {
      ...
      transform: translate(-50%,-50%);
      transition: width .3s ease-out, height .3s ease-out, border-color .3s, opacity .3s, background .3s;
      opacity: .5;
    }
    ...
    .loader-monogram path {
      ...
      animation: drawMono 1.2s ease-out forwards;
    }
    ...
    .nav-indicator {
      ...
      pointer-events: none; box-shadow: 0 0 8px var(--primary);
    }
    ...
    .hero-photo-wrap::after {
      ...
      background:
        linear-gradient(to right, var(--bg) 0%, rgba(5,8,16,.7) 30%, rgba(5,8,16,.1) 70%, transparent 100%),
    ...
    .scanline-overlay {
      ...
      background: repeating-linear-gradient(0deg, transparent, transparent 2px, rgba(0,245,196,.015) 2px, rgba(0,245,196,.015) 4px);
      pointer-events: none;
    }
    ...
    @keyframes pulse {
      ...
      50% { box-shadow: 0 0 14px #22c55e, 0 0 22px rgba(34,197,94,.4); }
    }
    ...
    .hero-subtitle-container {
      height: 36px; overflow: hidden; position: relative; margin-bottom: 36px;
    }
    .hero-subtitle {
      font-family: var(--font-display); font-size: 1.15rem; font-weight: 500;
      color: var(--text-muted); position: absolute; width: 100%; left: 0;
    ...
    .section-title {
      ...
      font-weight: 700; margin-bottom: 48px; line-height: 1.2;
    }
    ...
    .about-bio p {
      font-size: 1.1rem; color: var(--text); line-height: 1.85;
      font-style: italic; opacity: .9;
    }
    .about-bio .highlight { color: var(--primary); font-weight: 600; font-style: normal; }
    .about-stats { display: grid; grid-template-columns: 1fr 1fr; gap: 16px; }
    .stat-card {
      background: var(--glass-bg); backdrop-filter: blur(16px);
      -webkit-backdrop-filter: blur(16px);
      border: 1px solid var(--glass-border); border-radius: var(--radius);
      padding: 28px; text-align: center; transition: transform .3s, border-color .3s;
    }
    ...
    .stat-label { font-size: .82rem; color: var(--text-muted); margin-top: 6px; font-family: var(--font-mono); }
    ...
    .skill-pill {
      ...
      background: rgba(13,17,23,.5); backdrop-filter: blur(12px);
    ...
    .skill-pill:hover {
      ...
      box-shadow: 0 0 20px color-mix(in srgb, var(--glow) 30%, transparent),
                  inset 0 0 20px color-mix(in srgb, var(--glow) 8%, transparent);
      z-index: 2;
    }
    ...
    /* Category badges — top right of front card */
    .card-badges {
    ...
    .stack-tag {
      ...
      background: rgba(0,245,196,.1); border: 1px solid rgba(0,245,196,.15); color: var(--primary);
    }

    /* ═══════════════════════════════════════
       CERTIFICATIONS
       ═══════════════════════════════════════ */
    .certs-ribbon-wrapper {
      overflow-x: auto; padding-bottom: 16px;
      scrollbar-width: thin; scrollbar-color: var(--secondary) var(--surface);
    }
    ...
    .cert-card {
      flex-shrink: 0; width: 300px; padding: 28px;
    ...
    .contact-card {
      max-width: 580px; width: 100%; padding: 48px;
      background: var(--glass-bg); backdrop-filter: blur(24px); -webkit-backdrop-filter: blur(24px);
      border: 1px solid var(--glass-border); border-radius: var(--radius-lg); text-align: center;
    }
    ...
    .copy-email-btn {
      ...
      background: rgba(0,245,196,.1); border: 1px solid rgba(0,245,196,.2);
      font-family: var(--font-mono); font-size: .83rem; color: var(--primary);
    ...
    @media (max-width: 768px) {
      ...
      .mobile-nav-toggle {
        display: flex !important; position: fixed; top: 20px; right: 20px; z-index: 1001;
      ...
      .mobile-nav-toggle span::before, .mobile-nav-toggle span::after {
        content: ''; position: absolute; width: 20px; height: 2px; background: var(--text); transition: transform .3s;
      }
      ...
      .mobile-menu {
        ...
        background: rgba(5,8,16,.95); backdrop-filter: blur(20px); -webkit-backdrop-filter: blur(20px);
    ...
    *:focus-visible { outline: 2px solid var(--primary); outline-offset: 3px; border-radius: 4px; }
    .skip-link {
      position: fixed; top: -100%; left: 16px; z-index: 10002;
      padding: 12px 24px; background: var(--primary); color: var(--bg);
      font-weight: 600; border-radius: var(--radius); transition: top .3s;
    }
...
<body>
  ...
  <div class="loader" id="loader" aria-label="Loading">
    <div class="loader-monogram">
      <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        <path d="M15 80 L15 20 L35 55 L55 20 L55 80 M65 80 L65 20 L90 50 L65 80 Z"/>
      </svg>
    </div>
  </div>
  ...
  <header class="hero" id="hero">
    ...
    <div class="hero-photo-wrap">
      <img src="PHOTO_SRC_PLACEHOLDER" alt="Mohammed Adnan P — Full-Stack Developer & AI Engineer" loading="eager">
    </div>
    ...
    <!-- Open to work badge -->
    <div class="otw-badge" aria-label="Currently open to work">
    ...
    <div class="hero-content">
      ...
      <div class="hero-cta-group reveal">
        <a href="#projects" class="btn btn-primary magnetic-btn" aria-label="View my projects">View My Work</a>
        <a href="#contact"  class="btn btn-outline magnetic-btn" aria-label="Download resume">Download Resume</a>
      </div>
    </div>
  </header>
  ...
  <main id="main-content">
    ...
    <section class="section" id="about" aria-labelledby="about-title">
      ...
      <div class="about-grid">
        <div class="about-bio reveal">
          <p>
            "I'm an <span class="highlight">AI &amp; full-stack engineer</span> based in Tamil Nadu, building systems
            that sit at the intersection of intelligence, security, and speed.
            From <span class="highlight">RAG pipelines</span> to <span class="highlight">ESP32 encryption</span> —
            I make complex things work."
          </p>
        </div>
        <div class="about-stats reveal">
          ...
          <div class="stat-card">
            <span class="stat-number" data-target="753" data-decimal="2">0</span>
            <span class="stat-label">CGPA at VIT</span>
          </div>
          <div class="stat-card">
            <span class="stat-number" data-target="3" data-suffix="">0</span>
    ...
    <section class="section" id="skills" aria-labelledby="skills-title">
      ...
      <div class="skills-filter reveal" role="group" aria-label="Filter skills by category">
      ...
      <div class="skills-cloud reveal" role="list" aria-label="Skills">
        ...
        <span class="skill-pill" data-cat="lang" role="listitem" style="--float-dur:6.2s;--float-delay:0.3s"><span class="skill-dot"></span>Python</span>
        <span class="skill-pill" data-cat="lang" role="listitem" style="--float-dur:5.8s;--float-delay:0.1s"><span class="skill-dot"></span>JavaScript</span>
        <span class="skill-pill" data-cat="lang" role="listitem" style="--float-dur:6.5s;--float-delay:0.5s"><span class="skill-dot"></span>C</span>
        <span class="skill-pill" data-cat="lang" role="listitem" style="--float-dur:7s;--float-delay:0.2s"><span class="skill-dot"></span>C++</span>
        <span class="skill-pill" data-cat="db" role="listitem" style="--float-dur:6.8s;--float-delay:0.4s"><span class="skill-dot"></span>SQL</span>
        <span class="skill-pill" data-cat="db" role="listitem" style="--float-dur:5.3s;--float-delay:0.7s"><span class="skill-dot"></span>Firebase</span>
        <span class="skill-pill" data-cat="db" role="listitem" style="--float-dur:6s;--float-delay:0.15s"><span class="skill-dot"></span>MongoDB</span>
        <span class="skill-pill" data-cat="tools" role="listitem" style="--float-dur:5.7s;--float-delay:0.6s"><span class="skill-dot"></span>Git</span>
        <span class="skill-pill" data-cat="tools" role="listitem" style="--float-dur:6.3s;--float-delay:0.35s"><span class="skill-dot"></span>Docker</span>
        <span class="skill-pill" data-cat="tools" role="listitem" style="--float-dur:7.2s;--float-delay:0.8s"><span class="skill-dot"></span>FAISS</span>
        <span class="skill-pill" data-cat="tools" role="listitem" style="--float-dur:5.5s;--float-delay:0.45s"><span class="skill-dot"></span>Power BI</span>
        <span class="skill-pill" data-cat="tools" role="listitem" style="--float-dur:6.6s;--float-delay:0.25s"><span class="skill-dot"></span>Nmap</span>
        <span class="skill-pill" data-cat="tools" role="listitem" style="--float-dur:5.9s;--float-delay:0.55s"><span class="skill-dot"></span>Wireshark</span>
        <span class="skill-pill" data-cat="tools" role="listitem" style="--float-dur:6.1s;--float-delay:0.1s"><span class="skill-dot"></span>VS Code</span>
        <span class="skill-pill" data-cat="web" role="listitem" style="--float-dur:5.4s;--float-delay:0.65s"><span class="skill-dot"></span>React.js</span>
        <span class="skill-pill" data-cat="web" role="listitem" style="--float-dur:6.7s;--float-delay:0.2s"><span class="skill-dot"></span>Next.js</span>
        <span class="skill-pill" data-cat="ai" role="listitem" style="--float-dur:5.6s;--float-delay:0.5s"><span class="skill-dot"></span>FastAPI</span>
        <span class="skill-pill" data-cat="ai" role="listitem" style="--float-dur:7.1s;--float-delay:0.75s"><span class="skill-dot"></span>Streamlit</span>
        <span class="skill-pill" data-cat="ai" role="listitem" style="--float-dur:6.4s;--float-delay:0.3s"><span class="skill-dot"></span>PyTorch</span>
        <span class="skill-pill" data-cat="ai" role="listitem" style="--float-dur:5.2s;--float-delay:0.4s"><span class="skill-dot"></span>Scikit-Learn</span>
        <span class="skill-pill" data-cat="ai" role="listitem" style="--float-dur:6.9s;--float-delay:0.6s"><span class="skill-dot"></span>Hugging Face</span>
        <span class="skill-pill" data-cat="ai" role="listitem" style="--float-dur:5.8s;--float-delay:0.15s"><span class="skill-dot"></span>SentenceTransformers</span>
        <span class="skill-pill" data-cat="web" role="listitem" style="--float-dur:6.2s;--float-delay:0.85s"><span class="skill-dot"></span>Zustand</span>
        <span class="skill-pill" data-cat="web" role="listitem" style="--float-dur:5.5s;--float-delay:0.5s"><span class="skill-dot"></span>Recharts</span>
        <span class="skill-pill" data-cat="web" role="listitem" style="--float-dur:6.6s;--float-delay:0.35s"><span class="skill-dot"></span>Framer Motion</span>
        <span class="skill-pill" data-cat="web" role="listitem" style="--float-dur:5.3s;--float-delay:0.7s"><span class="skill-dot"></span>HTML &amp; CSS</span>
        <span class="skill-pill" data-cat="web" role="listitem" style="--float-dur:6.8s;--float-delay:0.2s"><span class="skill-dot"></span>REST APIs</span>
        <span class="skill-pill" data-cat="embedded" role="listitem" style="--float-dur:7s;--float-delay:0.45s"><span class="skill-dot"></span>ESP32</span>
        <span class="skill-pill" data-cat="embedded" role="listitem" style="--float-dur:5.7s;--float-delay:0.55s"><span class="skill-dot"></span>Arduino</span>
        <span class="skill-pill" data-cat="embedded" role="listitem" style="--float-dur:6.3s;--float-delay:0.1s"><span class="skill-dot"></span>AES-128</span>
        <span class="skill-pill" data-cat="embedded" role="listitem" style="--float-dur:5.9s;--float-delay:0.8s"><span class="skill-dot"></span>SHA-256</span>
        <span class="skill-pill" data-cat="embedded" role="listitem" style="--float-dur:6.5s;--float-delay:0.3s"><span class="skill-dot"></span>Embedded C</span>
      </div>
    </section>
    ...
    <section class="section" id="projects" aria-labelledby="projects-title">
      ...
      <div class="projects-grid">
        ...
        <article class="flip-card reveal" aria-label="NexusIntel project">
          <div class="flip-card-inner" tabindex="0" role="button" aria-label="Flip for NexusIntel details">
            <div class="flip-card-front">
              <div class="card-badges">
                <span class="project-category cat-fullstack">Full-Stack · AI</span>
                <span class="card-tag-badge">📈 FinTech AI</span>
              </div>
              ...
              <span class="project-date">Dec 2025 — Jan 2026</span>
              <span class="flip-hint">↻ Hover to flip</span>
            </div>
            <div class="flip-card-back">
              <h3 class="project-back-title">NexusIntel — Deep Dive</h3>
        ...
        <article class="flip-card reveal" aria-label="ESP32 Secure Data Encryption project">
          <div class="flip-card-inner" tabindex="0" role="button" aria-label="Flip for ESP32 project details">
            <div class="flip-card-front">
              <div class="card-badges">
                <span class="project-category cat-iot">IoT · Security</span>
                <span class="card-tag-badge">🔐 IoT Security</span>
              </div>
              <h3 class="project-name">ESP32 Secure Encryption</h3>
              <p class="project-oneliner">Hardware-level AES-128 + SHA-256 encryption system with session key rotation and replay attack protection for embedded communication.</p>
              <span class="project-date">Feb — Mar 2025</span>
              <span class="flip-hint">↻ Hover to flip</span>
            </div>
            <div class="flip-card-back">
              <h3 class="project-back-title">ESP32 Encryption — Deep Dive</h3>
              <ul class="project-details">
              ...
              <div class="project-stack">
                ...
                <span class="stack-tag">AES-128</span>
                <span class="stack-tag">SHA-256</span>
                <span class="stack-tag">HC-SR04</span>
              </div>
            </div>
          </div>
        </article>
        ...
        <article class="flip-card reveal" aria-label="VisualDebate project">
          <div class="flip-card-inner" tabindex="0" role="button" aria-label="Flip for VisualDebate details">
            <div class="flip-card-front">
              <div class="card-badges">
                <span class="project-category cat-ai">AI · NLP</span>
                <span class="card-tag-badge">🧠 NLP / AI</span>
              </div>
              <h3 class="project-name">VisualDebate</h3>
              <p class="project-oneliner">AI credibility intelligence platform that transcribes video, identifies claims via NLP, and auto-generates fact-checked rebuttals.</p>
              <span class="project-date">Mar — Apr 2026</span>
              <span class="flip-hint">↻ Hover to flip</span>
            </div>
            <div class="flip-card-back">
              <h3 class="project-back-title">VisualDebate — Deep Dive</h3>
              <ul class="project-details">
                <li>Analyses YouTube videos, transcribes speech, identifies checkworthy claims via NLP</li>
              ...
              <div class="project-stack">
                ...
                <span class="stack-tag">DistilBERT</span>
                <span class="stack-tag">FAISS</span>
                <span class="stack-tag">Faster-Whisper</span>
              </div>
            </div>
          </div>
        </article>
      ...
      <div class="certs-ribbon-wrapper reveal">
        <div class="certs-ribbon" role="list">
          <article class="cert-card" role="listitem">
            ...
            <h3 class="cert-title">Cybersecurity Foundations</h3>
            <p class="cert-issuer">Infosys Springboard</p>
          </article>
          <article class="cert-card" role="listitem">
            <div class="cert-icon" aria-hidden="true">📊</div>
            <h3 class="cert-title">Power BI &amp; Data Analytics</h3>
            <p class="cert-issuer">Hack the Dash Workshop</p>
          </article>
          <article class="cert-card" role="listitem">
            <div class="cert-icon" aria-hidden="true">⚛</div>
            <h3 class="cert-title">Quantum Programming — QISKIT</h3>
            <p class="cert-issuer">VIT School of CSE &amp; IS / Qiskit</p>
          </article>
        </div>
      </div>
    </section>
    ...
    <section class="section" id="contact" aria-labelledby="contact-title">
      <div class="contact-wrapper">
        <div class="contact-card reveal">
          ...
          <p class="contact-sub">I'm always open to collaborating on projects that push the boundaries of what software can do.</p>
          <div class="contact-links">
            <a href="mailto:mdadnan1903472@gmail.com" class="contact-link magnetic-el" aria-label="Send email">
            ...
            <a href="tel:+918778146085" class="contact-link magnetic-el" aria-label="Call">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07 19.5 19.5 0 01-6-6 19.79 19.79 0 01-3.07-8.67A2 2 0 014.11 2h3a2 2 0 012 1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45 12.84 12.84 0 002.81.7A2 2 0 0122 16.92z"/></svg>
              +91 8778146085
            </a>
            <a href="https://linkedin.com/in/" class="contact-link magnetic-el" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 8a6 6 0 016 6v7h-4v-7a2 2 0 00-4 0v7h-4v-7a6 6 0 016-6z"/><rect x="2" y="9" width="4" height="12"/><circle cx="4" cy="4" r="2"/></svg>
              LinkedIn
            </a>
            <a href="https://github.com/" class="contact-link magnetic-el" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 00-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0020 4.77 5.07 5.07 0 0019.91 1S18.73.65 16 2.48a13.38 13.38 0 00-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 005 4.77a5.44 5.44 0 00-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 009 18.13V22"/></svg>
              GitHub
            </a>
          </div>
          <button class="copy-email-btn" id="copy-email" aria-label="Copy email to clipboard">
  ...
  <footer class="site-footer">
    <p class="footer-text">Crafted with obsession by <span class="footer-name">Mohammed Adnan</span> · 2026</p>
  </footer>
  ...
  <script>
    ...
    window.addEventListener('scroll', function() {
      ...
      sp.style.width = Math.min(scrolled, 100) + '%';
    }, { passive: true });
    ...
    (function() {
      ...
      function addHover(els, cls1, cls2) {
        els.forEach(function(el) {
          el.addEventListener('mouseenter', function() { dot.classList.add(cls1); ring.classList.add(cls2); });
          el.addEventListener('mouseleave', function() { dot.classList.remove(cls1); ring.classList.remove(cls2); });
        });
      }
      ...
      /* Photo aperture cursor */
      var photoWrap = document.querySelector('.hero-photo-wrap');
      if (photoWrap) {
        photoWrap.addEventListener('mouseenter', function() { ring.style.borderRadius = '0'; ring.style.transform = 'translate(-50%,-50%) rotate(45deg)'; });
        photoWrap.addEventListener('mouseleave', function() { ring.style.borderRadius = '50%'; ring.style.transform = 'translate(-50%,-50%)'; });
      }
    })();
    ...
    (function() {
      ...
      for (var i = 0; i < N; i++) {
        particles.push({ x: Math.random()*canvas.width, y: Math.random()*canvas.height, vx: (Math.random()-.5)*.4, vy: (Math.random()-.5)*.4, r: Math.random()*1.5+.5, o: Math.random()*.5+.2 });
      }
      ...
      function draw() {
        ...
        for (var i = 0; i < particles.length; i++) {
          ...
          /* Warmer tones on right side (near photo) */
          var ratio = p.x / cw;
          var r = Math.round(0 + ratio * 80), g = Math.round(245 - ratio * 100), b = Math.round(196 - ratio * 80);
          ...
          for (var j = i+1; j < particles.length; j++) {
            ...
            if (dd < 120) {
              ...
              ctx.strokeStyle = 'rgba(0,245,196,'+a+')'; ctx.lineWidth = .5; ctx.stroke();
            }
          }
        }
    ...
    /* ══ SUBTITLE CYCLE ══ */
    (function() {
      var subs = [document.getElementById('sub-0'), document.getElementById('sub-1'), document.getElementById('sub-2')];
      var cur = 0;
      setInterval(function() {
        subs[cur].classList.remove('active'); subs[cur].classList.add('exit');
        setTimeout(function() { subs.forEach(function(s) { s.classList.remove('exit'); }); }, 500);
        cur = (cur+1) % subs.length; subs[cur].classList.add('active');
      }, 3000);
    })();
    ...
    (function() {
      ...
      var revObs = new IntersectionObserver(function(entries) {
        entries.forEach(function(e) {
          ...
          var parent = e.target.closest('.section') || e.target.closest('.hero');
          if (parent) {
        ...
        entries.forEach(function(e) {
          ...
          function step(ts) {
            ...
            if (dec > 0) {
              ...
              el.textContent = (val / divisor).toFixed(2) + suffix;
            } else {
    ...
    (function() {
      var navLinks  = document.querySelectorAll('.floating-nav .nav-link');
      ...
      function update() {
        var sy = window.scrollY + window.innerHeight/3, cur = '';
        sections.forEach(function(s) { if (s.offsetTop <= sy) cur = s.id; });
        navLinks.forEach(function(l) {
          l.classList.remove('active');
          if (l.getAttribute('data-section') === cur) { l.classList.add('active'); setInd(l); }
        });
      }
      window.addEventListener('scroll', update, { passive: true });
      update();
      setInd(document.querySelector('.nav-link.active'));
    })();
    ...
    (function() {
      ...
      var links  = document.querySelectorAll('[data-mobile-nav]');
    ...
    (function() {
      ...
      if (!btn) return;
      btn.addEventListener('click', function() {
        navigator.clipboard.writeText('mdadnan1903472@gmail.com').then(function() {
          btn.classList.add('copied');
          document.getElementById('copy-text').textContent = 'Copied!';
          setTimeout(function() {
            btn.classList.remove('copied');
            document.getElementById('copy-text').textContent = 'mdadnan1903472@gmail.com';
          }, 2000);
        });
      });
    })();
    ...
    /* ══ MAGNETIC HOVER ══ */
    (function() {
      var els = document.querySelectorAll('.magnetic-el, .magnetic-btn');
      els.forEach(function(el) {
...
$html = $html -replace 'PHOTO_SRC_PLACEHOLDER', $imgSrc
...
Write-Host "Done. Portfolio written successfully."
